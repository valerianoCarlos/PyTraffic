...
class IntersectionSim(mosaik_api_v3.Simulator):
    ...
    def graceful_shutdown(self, signum, frame):
        print("Received signal to shut down. Shutting down thread pool.")
    ...
    def step(self, time, inputs, max_advance):
        ...
        futures = [self.thread_pool.submit(estimate_pi) for _ in range(10)]
        _ = [future.result() for future in futures] # wait for all futures to complete the computation
